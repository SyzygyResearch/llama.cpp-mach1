...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_MACH1_TLUT,                             "mach1.tlut" },
    { LLM_TENSOR_MACH1_NE_TLUT,                          "mach1.ne_tlut" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_MACH1_TLUT,                 {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_GET_ROWS}}, // mach1 shared trellis codebook
    {LLM_TENSOR_MACH1_NE_TLUT,              {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_GET_ROWS}}, // mach1 v3 rotated-NE codebook
