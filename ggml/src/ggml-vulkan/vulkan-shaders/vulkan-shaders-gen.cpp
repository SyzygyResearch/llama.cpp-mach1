...
void process_shaders() {
    ...
    string_to_spv("mach1_embed_rows_f32", "mach1_embed_rows.comp", {});
    string_to_spv("mach1_ne_mm_f32",      "mach1_ne_mm.comp",      {});
    string_to_spv("mach1_exp_group_f32",  "mach1_exp_group.comp",  {});
    string_to_spv("mach1_exp_u_f32",      "mach1_exp_u.comp",      {});
    string_to_spv("mach1_exp_walk_f32",   "mach1_exp_walk.comp",   {});
    string_to_spv("mach1_exp_walk_v8_f32", "mach1_exp_walk.comp",  {{"MACH1_V8", "1"}});
